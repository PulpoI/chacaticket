...
const Precios: FunctionComponent = (props: any) => {
...
<LocalAddDialog
  ...
  action={ dialogAction }
  addOptions={ { title: 'Add Precio', text: 'Enter Precio data', button: 'Add' } }
  editOptions={ { title: 'Edit Precio', text: 'Update Precio data', button: 'Edit' } }
